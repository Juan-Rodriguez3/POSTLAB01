...
.cseg
.org 0x0000
//Desactivar la comunicacion serial del pin D y D1
    LDI R16, 0x00     ; Cargar 0 en R16
    STS UCSR0B, R16   ; Deshabilitar la UART (USART0)
;Ahora esos pines se pueden usar como entradas o salidas
...
CBR R19, 0b00010000  ; Borra el quinto bit de R19
CPI R18, 0x0F
BREQ REINICIO1
INC R18
OUT PORTD, R18
